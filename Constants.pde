static class Constants {
  ...
  static final float optionsForm_widthOffset = 30;
  static final float optionsForm_heightOffset = 20;
  ...
  static final float map_mapPerlinMultiplier = 0.05;
  ...
  static final float hero_scaling_health = 0.6;
  static final float hero_scaling_attack = 0.08;
  static final float hero_scaling_magic = 0.04;
  static final float hero_scaling_defense = 0.02;
  ...
  static final float ability_1021_speed = 1.8;
